...
export class PageService {
  private _pageInformation: PagesInformation = {
    'bellabestia': {
      ...
      description: `Proyecto final del curso sobre ilustración infantil impartido por Adolfo Serra. Buscando enfatizar el antagonismo de los dos
...
no es chusma como ustedes, como yo mismo””`
    ...
    'cuentos': {
      title: 'Cuentos',
      description: `Serie de portadillas para un recopilatorio de cuentos clásicos desarrollado durante el curso de “Diseño y edición de productos
...
había casado ya con varias mujeres y no se sabía qué había sido de ellas.” [Barba Azul-Charles Perrault]`
    ...
    'lavozeslava': {
      ...
      description: `Fanzine presentado en la feria de autoedición FUGAZ de Vitoria-Gasteiz en 2015. Los dibujos ilustran un texto propio. Son ilustraciones
...
casa a la desdichada y asesina Erinis enviada por los dioses vengadores!”`
    ...
    'narciso': {
      title: 'Narciso',
      description: `Proyecto no editado que ilustra un texto propio. Reinterpreta libremente el mito grecolatino de Narciso, que sirve de pretexto
